...
Project specialization adds product-specific requirements without weakening family rules.

## Requirements

### Requirement: Project profile

Each project SHALL define a profile naming backend, app type, sample rates, block-size range, routing model, event sources, control sources, telemetry, stress scenes, and inherited family revision.

### Requirement: No weakening

Project-specific specs SHALL NOT weaken the family doctrine, architecture boundary, or performance gates.

### Requirement: Stricter allowed

Project-specific specs MAY add stricter channel, latency, routing, telemetry, or stress-test requirements.
