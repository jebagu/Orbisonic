...
| `OrbisonicTests` | App runtime boundaries: local files, local library, live loopback, Roon, Spotify, Atmos DRP, Aux, renderer module, monitor path, diagnostics, web state, VU/metering, UI model behavior, build metadata, and architecture rules. | 431 |
