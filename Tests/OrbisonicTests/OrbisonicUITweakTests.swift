...
final class OrbisonicUITweakTests: XCTestCase {
    func testRendererPanelIsSimpleTwoChannelControlAndTuningIsCollapsible() throws {
        ...
        XCTAssertTrue(rendererTab.contains("settingsPanel(title: \"Mode\")"))
        XCTAssertTrue(rendererTab.contains("settingsPanel(title: \"Monitor Downmix\", fillsHeight: true)"))
        XCTAssertTrue(rendererTab.contains("settingsPanel(title: \"Sonic Sphere Render\", fillsHeight: true)"))
        XCTAssertFalse(rendererTab.contains("settingsPanel(title: \"Renderer\", fillsHeight: true)"))
